...
<head>
    ...
    <style>
        ...
        .welcome {
        width:440px;
        padding-left: 20px; /* Add some padding to the left of the text for spacing */
        }
        .welcome h1{
        text-align: left;
        }
...
<div class="welcome">
    <h1>Welcome Back, <?php echo  $_SESSION['First_Name'];?></h1>To see your account, <a href="User_Details.php" id="user">Click Here!</a>
    </div>
    <div class="logo">
